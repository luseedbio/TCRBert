...
def main():
    ...
    sub_parser.add_argument('--data', type=str, default='test,dash,dash_vdjdb_mcpas,iedb_sars2,iedb_sars2_exc_shomuradova,iedb_sars2_shomuradova,shomuradova,immunecode,zhang,nettcr_train,nettcr_eval')
